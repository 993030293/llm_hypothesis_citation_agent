...
def main() -> int:
    ...
    print("")
    print("QQ commands:")
    print("/preflight inputs/papers/teacher_live.pdf")
    print("/hypothesis inputs/papers/success_demo.pdf")
    print("/hypothesis inputs/papers/boundary_demo.pdf --bad")
    print("/hypothesis inputs/papers/teacher_live.pdf --live")
    print("")
